...
const examples = [
  ...
  { path: 'packages/ui/src/solid/chamferPropertyUpdates.ts',
    ...
    denied: ["import { update } from './solidSummary.js';", "export * from './solidSummary.js';",
      "import { state } from '../app/store.js';", "import { useState } from 'react';",
      "import('@pointercad/model');", "new Worker('worker.js');", "fetch('/');", "async function load() {}"] },
  { path: 'packages/ui/src/solid/surfacePropertyUpdates.ts',
    allowed: "import { expressionValueFromNumber } from '@pointercad/expression'; import { findMetricThread } from '@pointercad/model';",
    denied: ["import { update } from './solidSummary.js';", "export * from './solidSummary.js';",
      "import { state } from '../app/store.js';", "import { useState } from 'react';",
      "import('@pointercad/model');", "new Worker('worker.js');", "fetch('/');", "async function load() {}"] },
  ...
  { path: 'packages/ui/src/solid/SectionViewSection.tsx',
    allowed: "import { state } from '../store/useAppStore.js';",
  ...
  { path: 'packages/ui/src/solid/SelectionSetSection.tsx',
    allowed: "import { state } from '../store/useAppStore.js';",
    denied: ["import { Panel } from '../shell/PropertyPanel.js';", "import { create } from '@pointercad/expression/math/worker';", "import { shape } from '@pointercad/kernel';"] },
  { path: 'packages/ui/src/sketch/CanvasSection.tsx',
    allowed: "import { state } from '../store/useAppStore.js';",
    denied: ["import { Panel } from '../shell/PropertyPanel.js';", "import { create } from '@pointercad/expression/math/worker';", "import { shape } from '@pointercad/kernel';"] },
  { path: 'packages/ui/src/solid/PrintCheckSection.tsx',
    allowed: "import { state } from '../store/useAppStore.js';",
    denied: ["import { Panel } from '../shell/PropertyPanel.js';", "import { create } from '@pointercad/expression/math/worker';", "import { shape } from '@pointercad/kernel';"] },
  { path: 'packages/ui/src/sketch/InferConstraintsSection.tsx',
    allowed: "import { state } from '../store/useAppStore.js';",
    denied: ["import { Panel } from '../shell/PropertyPanel.js';", "import { create } from '@pointercad/expression/math/worker';", "import { shape } from '@pointercad/kernel';"] },
  { path: 'packages/ui/src/shell/propertySectionText.ts',
    allowed: "import { t } from '../i18n/t.js';",
    denied: ["import { Panel } from './PropertyPanel.js';", "import { useState } from 'react';",
      "import { state } from '../store/useAppStore.js';", "import('../i18n/t.js');"] },
  { path: 'packages/ui/src/solid/MeasurementSections.tsx',
    allowed: "import { useFieldUnits } from '../shell/propertyFieldUnits.js';",
    denied: ["import { Panel } from '../shell/PropertyPanel.js';", "import { create } from '@pointercad/expression/math/worker';", "import { shape } from '@pointercad/kernel';"] },
  { path: 'packages/ui/src/solid/measureFormatting.ts',
    allowed: "import { MM_PER_INCH } from '@pointercad/model';",
    denied: ["import { summary } from './solidSummary.js';", "import { state } from '../store/useAppStore.js';",
      "import { useState } from 'react';", "import('./solidSummary.js');", "export * from './solidSummary.js';"] },
  ...
  { path: 'packages/ui/src/sketch/numericInputChoices.ts',
    allowed: "import { DEFAULT_EXTRUDE_END } from '@pointercad/model'; import type { NumericChoice } from './numericInput.js';",
    denied: ["import { input } from './numericInput.js';", "export { input } from './numericInput.js';",
      "import { state } from '../app/store.js';", "import { useState } from 'react';",
      "import('./numericInput.js');", "new Worker('worker.js');", "fetch('/');", "async function choose() {}"] },
  { path: 'packages/ui/src/sketch/numericInputEvaluation.ts',
    allowed: "import { evaluateExpression } from '@pointercad/expression'; import type { NumericInputState } from './numericInput.js';",
    denied: ["import { input } from './numericInput.js';", "export { input } from './numericInput.js';",
      "import { state } from '../app/store.js';", "import { useState } from 'react';",
      "import('./numericInput.js');", "new Worker('worker.js');", "fetch('/');", "async function evaluate() {}"] },
  ...['twoPointArcInput.ts', 'splineInputDraft.ts'].map(name => ({
    path: `packages/ui/src/sketch/${name}`,
    allowed: "import { t } from '../i18n/t.js'; import { MAX_SPLINE_POINTS } from '@pointercad/model';",
    denied: ["import type { NumericInputState } from './numericInput.js';", "export * from './numericInput.js';",
      "import { state } from '../app/store.js';", "import { useState } from 'react';",
      "import('@pointercad/model');", "new Worker('worker.js');", "fetch('/');", "async function evaluate() {}"],
  })),
