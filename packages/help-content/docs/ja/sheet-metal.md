...
外周と穴、加工する板金、曲げるパネルと線、固定する側、フランジを付ける辺、曲げの逃げ穴の種類には、それぞれ何を選ぶ欄かを示す説明があります。元の板金から引き継ぐ内半径とK係数を、この曲げだけ変更する欄にも説明を添えています。マウスを置くかTabで移動して確認します。試し表示は文書へ確定せず、取消では確定前の変更を戻します。
