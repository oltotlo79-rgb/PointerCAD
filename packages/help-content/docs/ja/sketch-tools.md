...
**立体の頂点をクリックして点を作る。** 点の道具を選んで、立体の角(頂点)をクリックすると、その頂点に付く点ができます。あとで立体の大きさを変えても、点は同じ角に付いたまま動きます。線分・円弧・スプラインの道具でも、頂点をクリックするとそこが始点・終点になります。
...
**3D で使える道具**は、点・線分・円弧・スプライン・面の 5 つです。矩形・正多角形・長穴・円・2点円弧・楕円・点列・オフセットは、形が作図面の中の並びで決まるので使えません。押すと「作図面を選んでから作ってください。」と出ます。
