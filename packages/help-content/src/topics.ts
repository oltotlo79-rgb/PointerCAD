...
export const HELP_TOPICS: readonly HelpTopic[] = [
  ...
  { id: 'math-input', title: '構造化した数式と係数を入力する', path: 'docs/ja/math-input.md' },
  { id: 'function-curve', title: '関数とXYZの範囲から曲線を作る', path: 'docs/ja/function-curve.md' },
  { id: 'function-surface', title: '関数とXYZの範囲から曲面を作る', path: 'docs/ja/function-surface.md' },
  { id: 'function-point', title: '関数上に座標を指定して点を作る', path: 'docs/ja/function-point.md' },
  {
    id: 'parameters',
