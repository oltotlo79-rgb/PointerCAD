...
export const MANUAL_VOLUMES: readonly ManualVolume[] = [
  { id: 'getting-started', title: '導入・画面操作・ファイル', topics: [
    'web-version', 'help-reader', 'offline-use', 'local-data', 'startup-checks', 'tutorial', 'shortcuts', 'viewport', 'units', 'save-and-open', 'template', 'import', 'export', 'dxf', 'print-save-as',
  ] },
