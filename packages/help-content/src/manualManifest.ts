...
export const MANUAL_VOLUMES: readonly ManualVolume[] = [
  { id: 'getting-started', title: '導入・画面操作・ファイル', topics: [
    'help-reader', 'shortcuts', 'viewport', 'units', 'save-and-open', 'template', 'import', 'export', 'dxf', 'print-save-as',
  ] },
  ...
  { id: 'settings-and-history', title: '設定・履歴・表示', topics: [
    'feature-tree', 'history-notes', 'document-diff', 'timeline', 'display-settings', 'selection', 'named-view', 'section-view', 'font-licenses',
  ] },
];
