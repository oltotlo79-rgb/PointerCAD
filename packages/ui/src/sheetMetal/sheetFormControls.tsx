...
export function sheetCheckbox(label: string, checked: boolean, change: (next: boolean) => void, key: string): JSX.Element {
...
export function sheetSelect(label: MessageKey, value: string, change: (value: string) => void, options: readonly { key: string; name: string }[]): JSX.Element {
