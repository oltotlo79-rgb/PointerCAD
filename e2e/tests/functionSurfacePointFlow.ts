...
export async function functionSurfacePointFlow(page:Page,info:TestInfo,app?:ElectronApplication,scenario:'point'|'direction'='point'):Promise<void> {
  ...
  if(scenario==='direction'){await functionDirectionFlow(page,info,point,app,'parametric-surface');return;}
