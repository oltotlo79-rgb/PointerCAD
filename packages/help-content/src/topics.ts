...
export const HELP_TOPICS: readonly HelpTopic[] = [
  ...
  { id: 'desktop-install', title: 'デスクトップ版の導入・更新・削除', path: 'docs/ja/desktop-install.md' },
  ...
  { id: 'component-licenses', title: '使っている部品と許諾', path: 'docs/ja/component-licenses.md' },
  ...
  { id: 'math-symbols', title: '数学記号と演算の一覧', path: 'docs/ja/math-symbols.md' },
