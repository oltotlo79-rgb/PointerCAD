...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: /(?:smoke|solid|gdt|drawing-recovery|browser-security|sketch-intersections|strength|dwg|surfaces|cam|scripts|math-input|math-high-dpi|history-notes|function-plot|sheet-[\w-]+)\.spec\.ts$/u,
      grepInvert: VIEWPORT_PERFORMANCE_TEST,
      use: FIREFOX_USE,
